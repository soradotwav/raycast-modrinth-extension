export const modloaders: Map<string, string> = new Map([
  ["fabric", "#DBB69C"],
  ["quilt", "#C696F9"],
  ["forge", "#959EEF"],
  ["neoforge", "#F99E6B"]
...
export const modloaderIcons = {
  "fabric" : <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round" clip-rule="evenodd" viewBox="0 0 24 24">
